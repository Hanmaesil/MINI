...
public class character {
	...
	public void dume_sport_morning() {
		...
		while (true) {
			...
			System.out.print("\t\t\t\t\t\t" +"1. ¾ÆÄ§¿îµ¿ 2. ¸¶À» »êÃ¥°¡±â 3. ¹ä¸Ô°í Ãâ±ÙÇÏ±â >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"½Ã°ñÀÇ Á¤±â¸¦ ¹Þ¾Ò´Ù!!!");
					fun.timelate(1);
					defend_vir += ten;
	...
	public void dume_sport_ohu() {
		...
		while (true) {
			...
			System.out.print("\t\t\t\t\t\t" +" 1. ¹ä? ¾î¸²µµ¾øÁö ¿îµ¿ 2. ¹ä ¸Ô°í ¿îµ¿ 3. ÈÞ½Ä! >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				...
				if (rancnt == 0) {
					...
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" +"À½..? ±Ù¼Õ½ÇÀÌ ³µÀÝ¾Æ? ¾ÈµÅ¤À¤À¤À¤À!");
					healthcnt += minfive;
					defend_vir += minfive;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minfive + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
	...
	public int dume_sport_night(int endcnt) {
		...
		while (true) {
			while (true) {
				...
				System.out.print("\t\t\t\t\t\t" +" 1. Àú³á¿îµ¿ 2. Áý°¡¼­ ÀÚ±â 3. µî»ê°¡±â >>> ");
				choice = in.next();
				if (choice.equals("1")) {
					...
					if (rancnt == 0) {
						...
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" +"ÇÏÁö¸¸ ÀÇÇÐÀûÀ¸·Î ÀÚ±âÀü¿¡´Â ¿îµ¿ÀÌ ¾ÈÁÁ... ");
						defend_vir += minfive;
						System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
						status();
					}
					...
					rancnt = ran.nextInt(2);
					if (rancnt == 0) {
						System.out.println("\t\t\t\t\t\t" +"½Ã°ñ¹ö½º¸¦ ³õÃÄ¼­ Áý±îÁö ¶Ù¾î°¬´Ù!");
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" +"Áý±îÁö ¶Ù¾î°¡¼­ Èûµé¾î ÁöÃÄ ¾²·¯Á³´Ù.");
						healthcnt += minten;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minten + "Áõ°¡!");
						status();
					} else if (rancnt == 1) {
						System.out.println("\t\t\t\t\t\t" +"°£¸¸¿¡ Áý¿¡°¡¼­ Ç« ½¬¾ú´Ù.");
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" +"ÁýÀÌ ÃÖ°í¾ß!");
						defend_vir += ten;
						System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + ten + "Áõ°¡!");
						status();
					}
					...
					if (rancnt == 0) {
						...
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" +"»êÀÇ Á¤±â¸¦ ¹Þ¾Æ ¸é¿ª·Â ");
						healthcnt += five;
						defend_vir += five;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
						System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
	...
	public void dume_student_morning() {
		...
		while (true) {
			System.out.println("\t\t\t\t\t\t" +"¾ÆÄ§¿¡ ¹«¾ùÀ» ÇÒ °ÍÀÎ°¡¿ä?");
			fun.timelate(1);
			System.out.print("\t\t\t\t\t\t" +"1.»õº®ÀÌ ¹à¾Ò½À´Ï´Ù 2.´ßÀÌ ¿ï±â ½ÃÀÛÇÕ´Ï´Ù 3.¾Ä°í ÇÏ·ç¸¦ ÁØºñÇÏÁÒ >>> ");
			choice = in.next();
			if (choice.equals("1")) {
	...
	public void dume_student_ohu() {
		...
		while (true) {
			System.out.println("\t\t\t\t\t\t" +"Á¡½É¿¡ ¹«¾ùÀ» ÇÒ °ÍÀÎ°¡¿ä?");
			System.out.print("\t\t\t\t\t\t" +"1.Á¡½É³ª°¡¼­¸Ô±â 2.Á¡½É½ÃÄÑ¼­¸Ô±â 3.Á¡½É¸¸µé¾î¸Ô±â >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"¸ðµÎ°¡ Â¥ÀåÀ» ½ÃÅ³¶§ ³ª´Â Â«»ÍÀ» ½ÃÅ²´Ù!!");
					fun.timelate(1);
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"»¹Áþ¸¸ ÇÏ´Ù Á¡½ÉÀ» ¸ÔÁö ¸øÇß´Ù....");
					fun.timelate(1);
					healthcnt += minten;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minten + "Áõ°¡!");
					status();
	...
	public int dume_student_night(int endcnt) {
		while (true) {
			while (true) {
				...
				System.out.print("\t\t\t\t\t\t" +"1.ÀáÀÚ±â 2.¼ú¸Ô±â 3.³ÝÇÃ¸¯½º º¸±â >>> ");
				choice = in.next();
				if (choice.equals("1")) {
					alcol_cnt = 0;
					sleep();
					...
					if (rancnt == 0) {
						System.out.println("\t\t\t\t\t\t" +"\r\n"    //  221ÁÙ
								...
								+"\t\t\t\t\t\t" + "                                                  \r\n"
								+"\t\t\t\t\t\t" + "");
						System.out.println("\t\t\t\t\t\t" +"¿·Áý ¾ÆÀú¾¾°¡ Àå´ßÀ» Àâ¾Æ¿À¼Ì´Ù");
						fun.timelate(1);
						...
						System.out.println("\r\n"   // 1065¹øÂ° ÁÙ
					            ...
					            + "\t\t\t\t\t\t" +"                .,,,.                   \r\n"
					            + "\t\t\t\t\t\t" +"");
						System.out.println("\t\t\t\t\t\t" +"Ä£±¸ÁýÀ¸·Î ¼úÀ» ¸ÔÀ¸·¯ °¬´Ù");
						fun.timelate(1);
						rancnt = ran.nextInt(2);
						if (rancnt == 0) {
							healthcnt += minfive;
					...
					System.out.println("\t\t\t\t\t\t" +"´Ù¸Þ´Ù¸Þ ´Ù¸Þ¿ä");
				}
	...
	public void dume_nurse_morning() { // µÎ¸Þ °£È£»ç ¾ÆÄ§
		only_nur();
		omi_change();
		da_u_hang();
		gori();
		...
		while (true) {
			System.out.println("\t\t\t\t\t\t" + "¾ÆÄ§¿¡ ¹«¾ùÀ» ÇÒ °ÍÀÎ°¡¿ä?");
			System.out.print("\t\t\t\t\t\t" + "1. ¹ä ¸Ô°í Ãâ±ÙÇÏ±â 2. Ãâ±ÙÇÏ±â 3. 10ºÐ ´õ ÀÚ°í Áö°¢ÇÏ±â >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" + "ÇÇ°ïÇØ ¤Ð¤Ð Ãâ±ÙÇÏ±â ½È¾î");
					healthcnt += five;
					defend_vir += minfive;
					System.out.println("\t\t\t\t\t\t" + "Ã¼·ÂÀÌ " + minfive + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" + "¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
				...
				rancnt = ran.nextInt(2);
				if (rancnt == 0) {
					System.out.println("\t\t\t\t\t\t" + "10ºÐ ´õ ÀÜ´Ù´Â°Ô 2½Ã°£ ´õ ÀÚ¹ö·È´Ù");
					fun.timelate(1);
					...
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" + "10ºÐ ´õ ÀÚ¼­ ÇÇ·Î°¡ Ç®·È´Ù");
					healthcnt += five;
					defend_vir += five;
					System.out.println("\t\t\t\t\t\t" + "Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" + "¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
	...
	public void dume_nurse_ohu() { // µÎ¸Þ °£È£»ç ¿ÀÈÄ

		while (true) {
			System.out.println("\t\t\t\t\t\t" + "Á¡½É¿¡ ¹«¾ùÀ» ÇÒ °ÍÀÎ°¡¿ä?");
			System.out.print("\t\t\t\t\t\t" + "1. ¹ä¸Ô±â 2. ³·ÀáÀÚ±â 3. ¸¶À»È¸°ü¿¡¼­ ¼ö´Ù¶³±â >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				System.out.println("\t\t\t\t\t\t" + "µçµçÇÏ°Ô Á¡½ÉÀ» ¸Ô¾î¾ßÁö");
				fun.timelate(1);
				rancnt = ran.nextInt(2);
				if (rancnt == 0) {
					System.out.println("\t\t\t\t\t\t" + "µÎ¸Þ»ê°ñ ÃÖ°íÀÇ ¸ÀÁý¿¡¼­ ¹äÀ» ¸Ô¾ú´Ù");
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" + "µçµçÇØ¼­ ±âºÐÀÌ ÁÁ´Ù!");
					healthcnt += five;
					System.out.println("\t\t\t\t\t\t" + "Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					defend_vir += five;
					System.out.println("\t\t\t\t\t\t" + "¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
				...
				rancnt = ran.nextInt(2);
				if (rancnt == 0) {
					System.out.println("\t\t\t\t\t\t" + "¸¶À» ¾î¸£½ÅµéÇÑÅ× ÀÌ»Ý¹Þ´Â´Ù");
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" + "¿ëµ·µµ Áã¾îÁÖ½Å´Ù ±âºÐ ÃÖ°í~");
					healthcnt += minten;
					defend_vir += ten;
					System.out.println("\t\t\t\t\t\t" + "Ã¼·ÂÀÌ " + ten + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" + "¸é¿ª·ÂÀÌ " + ten + "Áõ°¡!");
					...
					System.out.println("\t\t\t\t\t\t" + "¸¶À» ¾î¸£½ÅµéÇÑÅ× °áÈ¥Àº ¾ðÁ¦ÇØ? ¶ó¶¼´Â ¸»¾ß ÄÞº¸¸¦ ¸Â¾Ò´Ù");
					fun.timelate(1);
	...
	public int dume_nurse_night(int endcnt) {
		while (true) {
			while (true) {
				System.out.println("\t\t\t\t\t\t" + "¹ã¿¡´Â ¹«¾ùÀ» ÇÒ°í¾ß?");
				System.out.print("\t\t\t\t\t\t" + "1.ÀáÀÚ±â 2.¼ú¸Ô±â 3.³ÝÇÃ¸¯½ºº¸±â >>> ");
				choice = in.next();
				if (choice.equals("1")) {
					alcol_cnt = 0;
					rancnt = ran.nextInt(2);
					...
					if (rancnt == 0) {
						...
						System.out.println("\t\t\t\t\t\t" + "À½... ¿©±ä ¾îµðÁö..?");
						fun.timelate(1);
						rancnt = ran.nextInt(2);
						if (rancnt == 1) {
							System.out.println("\t\t\t\t\t\t" + "³»°¡.. Áý¿¡ ¾î¶»°Ô µé¾î¿Ô´õ¶ó...?");
							fun.timelate(1);
							System.out.println("\r\n"   // 1065¹øÂ° ÁÙ
						            + "\t\t\t\t\t\t" + "\r\n"
						            + "\t\t\t\t\t\t" + "                 ;$$$$~                ~\r\n"
					...
					if (rancnt == 0) {
						...
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" + "³ÝÇÃ¸¯½º º¸´Ù°¡ ´ÊÀáÀÌ´Ù!");
						healthcnt += minten;
						System.out.println("\t\t\t\t\t\t" + "Ã¼·ÂÀÌ " + minten + "Áõ°¡!");
						defend_vir += five;
						System.out.println("\t\t\t\t\t\t" + "¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
						...
						System.out.println("\t\t\t\t\t\t" +"\r\n"   // ³ÝÇÃ¸¯½º
								...
								+"\t\t\t\t\t\t" + "                                   \r\n"
								+"\t\t\t\t\t\t" + "");
						System.out.println("\t\t\t\t\t\t" + "Àû´çÇÑ ³ÝÇÃ¸¯½º´Â ÀÎ»ý¿¡ µµ¿òÀÌ µÈ´Ù!!");
						healthcnt += five;
						System.out.println("\t\t\t\t\t\t" + "Ã¼·ÂÀÌ " + five + "Áõ°¡!");
						status();
					}
	...
	public void nor_student_morning() {
		...
		while (true) {
			System.out.println("\t\t\t\t\t\t" +"¾ÆÄ§¿¡ ¹«¾ùÀ» ÇÒ °ÍÀÎ°¡¿ä?");
			System.out.print("\t\t\t\t\t\t" +"1.ÀÏ¾î³ª±â 2.´ÊÀáÀÚ±â 3.¹ä¸Ô±â >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				System.out.println("\t\t\t\t\t\t" +"ÀÏ´Ü ÀÏ¾î³ª°í »ý°¢ÇØº¸ÀÚ");
				fun.timelate(1);
				rancnt = ran.nextInt(3);
				if (rancnt == 0) {
					System.out.println("\t\t\t\t\t\t" +"¿À! ´ÃÀº ¿ø°Ý¼ö¾÷!");
					fun.timelate(1);
					healthcnt += five;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					defend_vir += five;
					...
					System.out.println("\t\t\t\t\t\t" +"±³¼ö´ÔÀÇ ±â½ÀÈÞ°­~");
					healthcnt += five;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					defend_vir += five;
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"´ÊÀáÀÌ ¼¼»ó¿¡¼­ Á¦ÀÏ ´ÞÁö");
					fun.timelate(1);
					...
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" +"±³¼ö´ÔÀÇ ±ä±ÞÈÞ°­!!!");
					fun.timelate(1);
					healthcnt += five;
					defend_vir += ten;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
	...
	public void nor_student_evening() {
		while (true) {
			System.out.println("\t\t\t\t\t\t" +"Á¡½É¿¡ ¹«¾ùÀ» ÇÒ °ÍÀÎ°¡¿ä?");
			System.out.print("\t\t\t\t\t\t" +"1. ÇÐ½Ä¸Ô±â 2. ¸ÀÁýÅ½¹æ 3. ³î·¯°¡±â >>> ");
			choice = in.next();
			if (choice.equals("1")) {
				System.out.println("\t\t\t\t\t\t" +"µçµçÇÏ°Ô Á¡½ÉÀ» ¸Ô¾î¾ßÁö");
				fun.timelate(1);
				rancnt = ran.nextInt(3);
				if (rancnt == 0) {
					System.out.println("\t\t\t\t\t\t" +"¾îÁ¦µµ ÇÐ½Ä ¿À´Ãµµ ÇÐ½Ä...");
					...
					System.out.println("\t\t\t\t\t\t" +"ÇÐ½Ä¿¡ Ä¡Å²ÀÌ ³ª¿Ô´Ù!");
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" +"ÀÌ¸À¿¡ ÇÐ½Ä ¸ÔÁö~");
					healthcnt += five;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					defend_vir += five;
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
				...
				rancnt = ran.nextInt(3);
				if (rancnt == 0) {
					System.out.println("\t\t\t\t\t\t" +"ÀÎ±âÀýÁ¤ ¸ÀÁýÀ» Ã£¾Æ°¬´Ù");
					...
					System.out.println("\t\t\t\t\t\t" +"¿­½ÉÈ÷ °É¾î¼­ ¸ÀÁýÀ» Ã£¾Æ°¬´Âµ¥ ¹®À» ´Ý¾Ò´Ù!");
					System.out.println("\t\t\t\t\t\t" +"ÁöÃÄ ¤Ð");
					healthcnt += minfive;
					defend_vir += minfive;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minfive + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
				...
				if (rancnt == 0) {
					...
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" +"ÀÌÀ¯´Â ¸ð¸£Áö¸¸ Ã¼·Â°¨¼Ò ");
					healthcnt += minfive;
					defend_vir += minfive;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minfive + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
	...
	public int nor_student_night(int endcnt) {
		while (true) {
			while (true) {
				System.out.println("\t\t\t\t\t\t" +"¹ã¿¡´Â ¹«¾ùÀ» ÇÒ°í¾ß?");
				System.out.print("\t\t\t\t\t\t" +"1.¼ú¸¶½Ã±â 2.Å¬·´°¡±â 3.°úÁ¦ÇÏ±â >>> ");
				choice = in.next();
				if (choice.equals("1")) {
					alcol_cnt = 0;
					alcol();
					...
					if (rancnt == 0) {
						...
						System.out.println("\t\t\t\t\t\t" +"ÁÁ¾ÆÇÏ´Â ¿©ÀÚ¾Ö°¡ °úÁ¦ ´ë½Å ÇØ´Þ¶ó°í Çß´Ù");
		...
		while (true) {
			...
			if (choice.equals("1")) {
				...
				if (rancnt == 0) {
					...
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" +"±âºÐÀÌ ÁÁ¾Æ °¨¼º±ÙÀ°ÀÌ Áõ°¡Çß´Ù!");
					healthcnt += five;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					defend_vir += five;
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + five + "Áõ°¡!");
					...
					fun.timelate(1);
					System.out.println("\t\t\t\t\t\t" +"°¡½¿ÀÌ ¾ø´Â ´ßÀÇ ÀúÁÖ¸¦ ¹Þ¾Æ ¸é¿ª·Â °¨¼Ò!!");
					healthcnt += ten;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + ten + "Áõ°¡!");
					defend_vir += minten;
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minten + "Áõ°¡!");
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"\r\n"   // 398   // 517
							...
							+"\t\t\t\t\t\t" + "       ,=@@@$;.                                   \r\n"
							+"\t\t\t\t\t\t" + "");
					System.out.println("\t\t\t\t\t\t" +"´ýº§À» ¹ß¿¡ ¶³¾î¶ß·Á¹ö·Ç´Ù.....Á¨Àå");
					healthcnt += minten;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minten + "Áõ°¡!");
					status();
				} else {
					System.out.println("\t\t\t\t\t\t" +"³ªÀÇ ¸ñÇ¥´Â ¾ð´õ¾Æ¸Ó ¹«¸®ÇØ¼­¶óµµ ¿îµ¿ÀÌ´Ù!");
					healthcnt += five;
					defend_vir += minfive;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
					System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"¹«È£Èí(Ùíû¼ýå) 100¿¬ ¹öÇÇ");
					fun.timelate(1);
		...
		while (true) {
			while (true) {
				...
				if (choice.equals("1")) {
					...
					rancnt = ran.nextInt(3);
					if (rancnt == 0) {
						System.out.println("\t\t\t\t\t\t" +"¸¶½ºÅ©¸¦ ±ôºýÇÏ°í ³ª¿Ô´Ù..!!");
						fun.timelate(1);
						...
						System.out.println("\t\t\t\t\t\t" +"³» ¸ñÇ¥´Â ¾ð´õ¾Æ¸Ó");
						fun.timelate(1);
						...
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" +"ÇÏ...ÇÏÁö¸¸...·çÆ¾À» ±ý¼ø ¾ø´Â°É?");
						healthcnt += five;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
						status();
					}
					...
					rancnt = ran.nextInt(3);
					if (rancnt == 0) {
						System.out.println("\t\t\t\t\t\t" +"À¯ºZÀ»º¸´Ù »õ“Ý 4½Ã°¡µÇ¾ú´Ù.....");
						fun.timelate(1);
						System.out.println("\t\t\t\t\t\t" +"\"Á¾±¹ÀÌÇüÀÌ¶û °°ÀÌ ¹Þ´Â ÀÚ±Ø...Â¥¸´ÇØ¢½\"");
						healthcnt += ten;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + ten + "Áõ°¡!");
						defend_vir += minfive;
						System.out.println("\t\t\t\t\t\t" +"¸é¿ª·ÂÀÌ " + minfive + "Áõ°¡!");
						...
						System.out.println("\t\t\t\t\t\t" +"\r\n"  //  312ÁÙ
								...
								+"\t\t\t\t\t\t" + "                                              \r\n"
								+"\t\t\t\t\t\t" + "");
						System.out.println("\t\t\t\t\t\t" +"Á¾±¹ÀÌÇü À¯Æ©ºê´Â ÀÎ»ý¿¡ µµ¿òÀÌ µÈ´Ù!!");
						healthcnt += five;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
						status();
					}
...
//			}
			...
			if (choice.equals("1") || choice.equals("2") || choice.equals("3")) {
				...
				if (rancnt == 0) {
					...
					if (rancnt == 0) {
						...
						System.out.println("\t\t\t\t\t\t" +"Á¶±Ý ¾ÆÇÁ±ä ÇßÁö¸¸ ¸çÄ¥ ´©¿öÀÖÀ¸´Ï ±¦Âú¾ÆÁ³´Ù!!");
						healthcnt += ten;
					...
					System.out.println("\r\n"
				            ...
				            +"\t\t\t\t\t\t" + "           ,,                                                         \r\n"
				            +"\t\t\t\t\t\t" + "");
					System.out.println("\t\t\t\t\t\t" +"³»°¡ ¸ÂÀ» ¹é½ÅÀº ¸ð´õ³ª");
					fun.timelate(1);
		...
		while (true) {
			...
			if (choice.equals("1")) {
				...
				if (rancnt == 0) {
					...
					System.out.println("\t\t\t\t\t\t" +"±âºÐÀÌ ÁÁ¾ÆÁ³´Ù!");
					healthcnt += five;
					System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ" + five + "Áõ°¡!");
					status();
				}
	...
	public void seoul_nur_afternoon() {
		while (true) {
			...
			if (rancnt == 0) {
				fun.timelate(1);
				System.out.println("\t\t\t\t\t\t" +"ÇÏÁö¸¸ ¹Ð·Áµå´Â È¯ÀÚ¿¡ ÀÇÇØ ³ª´Â È¯ÀÚ¸¦ º¸°Ô µÇ¾ú´Ù.");
				fun.timelate(1);
				healthcnt += minten;
				System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minten + "Áõ°¡!");
				status();
				...
				System.out.print("\t\t\t\t\t\t" +"1.¹ä¸Ô±â 2.³·ÀáÀÚ±â 3.¼ö´Ù¶³±â >>> ");
				choice = in.next();
				if (choice.equals("1")) {
					rancnt = ran.nextInt(2);
					if (rancnt == 0) {
						...
						System.out.println("\t\t\t\t\t\t" +"¹äÀ» ±ÞÇÏ°Ô ¸Ô´Ù Ã¼ÇØ¹ö·È´Ù...");
						healthcnt += minten;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minten + "Áõ°¡!");
						status();
					}
					...
					if (rancnt == 0) {
						...
						System.out.println("\t\t\t\t\t\t" +"Á¤½ÅÀû Å¸°ÝÀÌ »ý°å´Ù");
						healthcnt += minfive;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + minfive + "Áõ°¡!");
						status();
					}
					...
					rancnt = ran.nextInt(3);
					if (rancnt == 0) {
						System.out.println("\t\t\t\t\t\t" +"Àú³â ³²ÀÚÄ£±¸°¡ ¿¡¸£¸Þ½º¸¦ ¼±¹°ÇØÁá´Ù³× Âü³ª");
						fun.timelate(1);
						...
						System.out.println("\t\t\t\t\t\t" +"½Ã°£°¡´ÂÁÙ ¸ð¸£°í ÀÖ¾úµû! ¼Ò¼ÒÇÑ Çàº¹");
						healthcnt += five;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
						status();
					}
				...
				if (choice.equals("1")) {
					...
					if (rancnt == 0) {
						...
						System.out.println("\t\t\t\t\t\t" +"\r\n"  //  312ÁÙ
								...
								+"\t\t\t\t\t\t" + "                                              \r\n"
								+"\t\t\t\t\t\t" + "");
						System.out.println("\t\t\t\t\t\t" +"Àû´çÇÑ À¯Æ©ºê´Â ÀÎ»ý¿¡ µµ¿òÀÌ µÈ´Ù!!");
						healthcnt += five;
						System.out.println("\t\t\t\t\t\t" +"Ã¼·ÂÀÌ " + five + "Áõ°¡!");
						status();
					}
...
//				}
	...
	public int nurse_baksin() {
		...
		while (cnt == 0 || cnt == 1) {
			...
			System.out.print("\t\t\t\t\t\t" +"1.¹é½Å ³õ¾ÆÁÖ±â 2.¹é½Å ³î¾ÆÁÖ±â 3.¹é½Å ³õ¾ÆÁÖ±â >>> ");
			choice = in.next();
			rancnt = ran.nextInt(3);
			if (rancnt == 0) {
				 System.out.println("\r\n"
		...
		while (true) {
			...
			fun.timelate(1);
			System.out.print("\t\t\t\t\t\t" +"1.¹é½Å ³õ¾ÆÁÖ±â 2.¹é½Å ³õ¾ÆÁÖ±â 3.¼ú¸Ô±â >>> ");
			choice = in.next();
			if (choice.equals("3")) {
				alcol();
				break;
				...
				System.out.println("\t\t\t\t\t\t" +"ÀÀ¾Ö ³ª ¾Ö±â¼±ÅÃÁö ÀÌ°Ç¸ð¸£°Ù¿À ÀÀ¾Ö");
			}
		}
		return endcnt;
	}
